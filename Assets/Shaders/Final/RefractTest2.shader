      ...
      int _TransferCount;
        ...
        //id = safeID(id, _TransferCount);
            ...
            float3 col;
             ...
             float2 uvVal = (v.screenPos.yx/v.screenPos.w );
            ...
            // uvVal = float2( abs(uvVal.x % 1) , abs(uvVal.y  % 1));
            ...
            // uvVal = (((v.pos.yx / v.pos.w)/_ScreenParams.yx) + 1)/2 ;///  (_ScreenParams.yx));
