    ...
    #pragma multi_compile_fwdbase nolightmap nodirlightmap nodynlightmap novertexlight
      ...
      int _TransferCount;
        ...
        //id = safeID(id, _TransferCount);
            ...
            float3 fNor = norAdd * radius * radius * 20 + v.nor;// + norAdd * radius * .2;
            ...
            float3 refracted = v.worldPos - .003 * normalize(refract( normalize(v.eye), fNor , .9 ));
